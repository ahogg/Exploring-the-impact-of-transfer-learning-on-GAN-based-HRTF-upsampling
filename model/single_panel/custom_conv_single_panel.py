...
class _ConvNdSinglePanel(Module):
    ...
    def __init__(self,
        ...
        super(_ConvNdSinglePanel, self).__init__()
    ...
    def __setstate__(self, state):
        super(_ConvNdSinglePanel, self).__setstate__(state)
        if not hasattr(self, 'padding_mode'):
            self.padding_mode = 'zeros'


class CubeSphereConv2DSinglePanel(_ConvNdSinglePanel):
    ...
    * :attr:`dilation` controls the spacing between the kernel points; also
    ...
    def __init__(
        ...
        super(CubeSphereConv2DSinglePanel, self).__init__(
